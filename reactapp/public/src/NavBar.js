  ...
  return (
    <nav>
       ...
       <h1>INSURANCE</h1>
        ...
        <div class="dropdown">
        <button class="dropbtn" style={{color:"lightgreen"}}>Claims</button>
        <div class="dropdown-content">
        <a href="claimintimation">Cliam Intimation</a>
        <a href="/claimprocess">Cliam Process</a>
        <a href="/claimstatus">Cliam Status</a>
        </div>
        </div>
        <div class="dropdown">
        <button class="dropbtn" style={{color:"lightgreen"}}>Plans</button>
        <div class="dropdown-content">
